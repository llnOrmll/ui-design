...
These constants are defined on the [`WebGLRenderingContext`](/en-US/docs/Web/API/WebGLRenderingContext) interface.

### Clearing buffers

Constants passed to [`WebGLRenderingContext.clear()`](/en-US/docs/Web/API/WebGLRenderingContext/clear) to clear buffer masks.
...
Constants passed to [`WebGLRenderingContext.drawElements()`](/en-US/docs/Web/API/WebGLRenderingContext/drawElements) or [`WebGLRenderingContext.drawArrays()`](/en-US/docs/Web/API/WebGLRenderingContext/drawArrays) to specify what kind of primitive to render.
...
Constants passed to [`WebGLRenderingContext.blendFunc()`](/en-US/docs/Web/API/WebGLRenderingContext/blendFunc) or [`WebGLRenderingContext.blendFuncSeparate()`](/en-US/docs/Web/API/WebGLRenderingContext/blendFuncSeparate) to specify the blending mode (for both, RGB and alpha, or separately).
...
Constants passed to [`WebGLRenderingContext.blendEquation()`](/en-US/docs/Web/API/WebGLRenderingContext/blendEquation) or [`WebGLRenderingContext.blendEquationSeparate()`](/en-US/docs/Web/API/WebGLRenderingContext/blendEquationSeparate) to control how the blending is calculated (for both, RGB and alpha, or separately).
...
Constants passed to [`WebGLRenderingContext.getParameter()`](/en-US/docs/Web/API/WebGLRenderingContext/getParameter) to specify what information to return.
...
`VIEWPORT` | 0x0BA2 | Returns an [`Int32Array`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Int32Array) with four elements for the current viewport dimensions.  
`SCISSOR_BOX` | 0x0C10 | Returns an [`Int32Array`](/en-US/docs/Web/JavaScript/Reference/Global_Objects/Int32Array) with four elements for the current scissor box dimensions.  
...
Constants passed to [`WebGLRenderingContext.getVertexAttrib()`](/en-US/docs/Web/API/WebGLRenderingContext/getVertexAttrib).
...
Constants passed to [`WebGLRenderingContext.cullFace()`](/en-US/docs/Web/API/WebGLRenderingContext/cullFace).
...
Constants passed to [`WebGLRenderingContext.enable()`](/en-US/docs/Web/API/WebGLRenderingContext/enable) or [`WebGLRenderingContext.disable()`](/en-US/docs/Web/API/WebGLRenderingContext/disable).
...
Constants returned from [`WebGLRenderingContext.getError()`](/en-US/docs/Web/API/WebGLRenderingContext/getError).
...
Constants passed to [`WebGLRenderingContext.frontFace()`](/en-US/docs/Web/API/WebGLRenderingContext/frontFace).
...
Constants passed to [`WebGLRenderingContext.hint()`](/en-US/docs/Web/API/WebGLRenderingContext/hint)
...
`GENERATE_MIPMAP_HINT` | 0x8192 | Hint for the quality of filtering when generating mipmap images with [`WebGLRenderingContext.generateMipmap()`](/en-US/docs/Web/API/WebGLRenderingContext/generateMipmap).  
...
Constants passed to [`WebGLRenderingContext.createShader()`](/en-US/docs/Web/API/WebGLRenderingContext/createShader) or [`WebGLRenderingContext.getShaderParameter()`](/en-US/docs/Web/API/WebGLRenderingContext/getShaderParameter)
...
Constants passed to [`WebGLRenderingContext.depthFunc()`](/en-US/docs/Web/API/WebGLRenderingContext/depthFunc) or [`WebGLRenderingContext.stencilFunc()`](/en-US/docs/Web/API/WebGLRenderingContext/stencilFunc).
...
Constants passed to [`WebGLRenderingContext.stencilOp()`](/en-US/docs/Web/API/WebGLRenderingContext/stencilOp).
...
Constants passed to [`WebGLRenderingContext.texParameteri()`](/en-US/docs/Web/API/WebGLRenderingContext/texParameter "WebGLRenderingContext.texParameteri\(\)"), [`WebGLRenderingContext.texParameterf()`](/en-US/docs/Web/API/WebGLRenderingContext/texParameter "WebGLRenderingContext.texParameterf\(\)"), [`WebGLRenderingContext.bindTexture()`](/en-US/docs/Web/API/WebGLRenderingContext/bindTexture), [`WebGLRenderingContext.texImage2D()`](/en-US/docs/Web/API/WebGLRenderingContext/texImage2D), and others.
...
Constants passed to [`WebGLRenderingContext.pixelStorei()`](/en-US/docs/Web/API/WebGLRenderingContext/pixelStorei).
...
These constants are defined on the [`WebGL2RenderingContext`](/en-US/docs/Web/API/WebGL2RenderingContext) interface. All WebGL 1 constants are also available in a WebGL 2 context.
...
For more information, see [`ANGLE_instanced_arrays`](/en-US/docs/Web/API/ANGLE_instanced_arrays).
...
For more information, see [`WEBGL_debug_renderer_info`](/en-US/docs/Web/API/WEBGL_debug_renderer_info).
...
For more information, see [`EXT_texture_filter_anisotropic`](/en-US/docs/Web/API/EXT_texture_filter_anisotropic).
...
For more information, see [`WEBGL_compressed_texture_s3tc`](/en-US/docs/Web/API/WEBGL_compressed_texture_s3tc).
...
For more information, see [`WEBGL_compressed_texture_etc`](/en-US/docs/Web/API/WEBGL_compressed_texture_etc).
...
`COMPRESSED_RGBA_PVRTC_2BPPV1_IMG` | 0x8C03 | RGBA compression in 2-bit mode. One block for each 8Ã4 pixels.  
  
For more information, see [`WEBGL_compressed_texture_pvrtc`](/en-US/docs/Web/API/WEBGL_compressed_texture_pvrtc).
...
For more information, see [`WEBGL_compressed_texture_etc1`](/en-US/docs/Web/API/WEBGL_compressed_texture_etc1).
...
For more information, see [`WEBGL_depth_texture`](/en-US/docs/Web/API/WEBGL_depth_texture).
...
For more information, see [`OES_texture_half_float`](/en-US/docs/Web/API/OES_texture_half_float).
...
For more information, see [`WEBGL_color_buffer_float`](/en-US/docs/Web/API/WEBGL_color_buffer_float).
...
For more information, see [`EXT_blend_minmax`](/en-US/docs/Web/API/EXT_blend_minmax).
...
For more information, see [`EXT_sRGB`](/en-US/docs/Web/API/EXT_sRGB).
...
For more information, see [`OES_standard_derivatives`](/en-US/docs/Web/API/OES_standard_derivatives).
...
For more information, see [`WEBGL_draw_buffers`](/en-US/docs/Web/API/WEBGL_draw_buffers).
...
For more information, see [`OES_vertex_array_object`](/en-US/docs/Web/API/OES_vertex_array_object).
...
For more information, see [`EXT_disjoint_timer_query`](/en-US/docs/Web/API/EXT_disjoint_timer_query).
...
---  
[WebGL  
# 5.14](https://www.khronos.org/registry/webgl/specs/latest/1.0/#5.14)  
[WebGL2  
# 3.7](https://www.khronos.org/registry/webgl/specs/latest/2.0/#3.7)  
...
This page was last modified on â¨Nov 21, 2024â© by [MDN contributors](/en-US/docs/Web/API/WebGL_API/Constants/contributors.txt). 

[View this page on GitHub](https://github.com/mdn/content/blob/main/files/en-us/web/api/webgl_api/constants/index.md?plain=1 "Folder: â¨en-us/web/api/webgl_api/constantsâ© \(Opens in a new tab\)") â¢ [Report a problem with this content](https://github.com/mdn/content/issues/new?template=page-report.yml&mdn-url=https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FWebGL_API%2FConstants&metadata=%3C%21--+Do+not+make+changes+below+this+line+--%3E%0A%3Cdetails%3E%0A%3Csummary%3EPage+report+details%3C%2Fsummary%3E%0A%0A*+Folder%3A+%60en-us%2Fweb%2Fapi%2Fwebgl_api%2Fconstants%60%0A*+MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FWebGL_API%2FConstants%0A*+GitHub+URL%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fblob%2Fmain%2Ffiles%2Fen-us%2Fweb%2Fapi%2Fwebgl_api%2Fconstants%2Findex.md%0A*+Last+commit%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fcommit%2F93b34fcdb9cf91ff44f5dfe7f4dcd13e961962da%0A*+Document+last+modified%3A+2024-11-21T19%3A49%3A47.000Z%0A%0A%3C%2Fdetails%3E "This will take you to GitHub to file a new issue.")
